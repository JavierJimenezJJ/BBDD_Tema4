...
CREATE OR REPLACE FUNCTION APELLIDOEMP(PDNI VARCHAR) RETURN VARCHAR IS
APELLIDO VARCHAR(10);
BEGIN 
SELECT E.APELLIDOS INTO APELLIDO 
FROM EMPLEADOS E
JOIN DATOSPERSONALES P ON E.ID_EMPLEADO = P.CLAVE_EMPLEADO
WHERE P.DNI = PDNI;
...
PDNI VARCHAR(10) := '09562145H';
BEGIN 
VAPELLIDO := APELLIDOEMP(PDNI);
END;