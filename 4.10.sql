...
ALTER TABLE DIRECTOR ADD CONSTRAINT UN_DIRECTOR UNIQUE (TELEFONO_DIRECTOR);
ALTER TABLE VENDEDOR ADD CONSTRAINT UN_VENDEDOR UNIQUE (TELEFONO_VERDEDOR);
ALTER TABLE CLIENTE ADD CONSTRAINT UN_CLIENTE UNIQUE (TELEFONO_CLIENTE);

ALTER TABLE PRODUCTO ADD CONSTRAINT UN_PRODUCTO UNIQUE (DESCRIPCION);


ALTER TABLE LINEA_VENTA ADD CONSTRAINT CHECK_LV CHECK (NUM_LINEA BETWEEN 1 AND 99);
